...
public class XMLTranslator<T> implements Translator<T> {
	...
	private final com.github.thiagotgm.bot_utils.storage.xml.XMLTranslator<T> translator;
	 ...
	 */
	public XMLTranslator( com.github.thiagotgm.bot_utils.storage.xml.XMLTranslator<T> translator ) {
	 ...
	 */
	public com.github.thiagotgm.bot_utils.storage.xml.XMLTranslator<T> getXMLTranslator() {
